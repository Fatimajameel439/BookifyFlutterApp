...
class _AddBooksState extends State<AddBooks> {
  ...
  final List<String> categories = [
    "Featured", "Popular", "Best Selling", "Novels",
    "Self Love", "Action", "History", "Fantasy",
    "Romance", "Science", "Poetry", "All Books"
  ];
  ...
  Future<String?> uploadImageToSupabase(Uint8List bytes, String name) async {
    try {
      ...
      await _storageSupabase.uploadBinary(fileName, bytes, fileOptions: const FileOptions(upsert: false));
  ...
  void handleSubmit() async {
    if (_formKey.currentState!.validate() && _imageBytes != null && _imageName != null) {
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
                ...
                child: _imageBytes != null
                    ...
                    : const Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.image, size: 40, color: Colors.teal),
                            SizedBox(height: 8),
                            Text("Tap to upload book image", style: TextStyle(color: Colors.teal)),
                          ],
                        ),
                      ),
              ),
            ...
            buildTextField(titleController, "Book Title", Icons.book),
            buildTextField(authorController, "Author", Icons.person),
            buildTextField(priceController, "Price", Icons.attach_money, isNumber: true),
